    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td class="text-center" style="font-size: 20pt; height: 36px">
                <asp:DropDownList ID="DropDownList1" runat="server" style="font-size: 18pt" Width="273px">
        ...
        <tr>
            ...
            <td class="text-center" style="font-size: 20pt">
                <asp:Calendar ID="Calendar1" runat="server" Height="166px" Width="220px"></asp:Calendar>
            </td>
        </tr>
        <tr>
            <td class="text-right" style="font-size: 20pt; width: 528px">

<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="DesarrolloWEB.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:TextBox ID="User" runat="server" CssClass="form-control" OnTextChanged="User_TextChanged"></asp:TextBox>
